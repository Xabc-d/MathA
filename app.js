...
const goappEnv = {"GOAPP_INTERNAL_URLS":"null","GOAPP_ROOT_PREFIX":"/MathA","GOAPP_STATIC_RESOURCES_URL":"/MathA","GOAPP_VERSION":"951425fb1961f20a9c561339379b806abf6c908b"};
...
async function goappInitWebAssembly() {
  ...
  try {
    ...
    const wasm = await instantiateStreaming(
      fetchWithProgress("/MathA/web/app.wasm", showProgress),
      go.importObject
    );
